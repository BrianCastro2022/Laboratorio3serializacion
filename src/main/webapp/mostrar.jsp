...
<style>
  html, body {
    ...
    margin: 0;
    padding: 0;
    font-family: serif; /* Cambia el estilo de la fuente a serif */
    background-image: url('https://cdn.pixabay.com/photo/2014/12/27/16/38/planet-581239_1280.jpg'); /* Establece la imagen de fondo */
